...
class CodeExecutorToolInput(BaseModel):
    prompt: str = Field(..., description="The prompt to generate code for")
    python_code: str = Field(default="", description="The Python code to review, update and execute to solve the task in the prompt")
...
class CodeExecutorTool(BaseTool):
    ...
    description: str = """
    Review and execute Python code to solve tasks. This is your primary tool for taking action through code.
    ...
    args_schema: Type[BaseModel] = CodeExecutorToolInput
