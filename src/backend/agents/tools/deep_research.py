...
from state import DeepResearchToolInput, DeepResearchToolExecutionResult
...
class DeepResearchTool(BaseTool):
    ...
    response_format: Type[BaseModel] = DeepResearchToolExecutionResult


    def _run(self, prompt: str) -> DeepResearchToolExecutionResult:
    ...
    async def _arun(self, prompt: str) -> DeepResearchToolExecutionResult:
        ...
        try:
            ...
            return DeepResearchToolExecutionResult(is_successful=True,
                                                   result=output if output else "",
                                                   error="")
        
        except Exception as e:
            return DeepResearchToolExecutionResult(
                is_successful=False,
                error=str(e),
                result=""
            )
