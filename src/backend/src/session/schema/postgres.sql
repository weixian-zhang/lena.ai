...
-- Append-only transcript. id IDENTITY is insertion order AND conversation order
-- — every ordinary append satisfies both at once. content is the AgentMessage as
-- JSON.
--
...
CREATE TABLE IF NOT EXISTS messages (
    ...
    compacted_start_id BIGINT,                     -- splice point; summary rows only
